...
class FLAME(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.register_buffer('dynamic_lmk_faces_idx', lmk_embeddings['dynamic_lmk_faces_idx'].type(torch.long))
        self.register_buffer('dynamic_lmk_bary_coords', lmk_embeddings['dynamic_lmk_bary_coords'].type(self.dtype))        
